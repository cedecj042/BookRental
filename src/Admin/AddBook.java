...
public class AddBook extends javax.swing.JPanel {
    ...
    public AddBook(AdminHome home, AdminExecutable executable) {
        initComponents();
        setOpaque(false);
    ...
    private void initComponents() {
        ...
        Book.setText("Book");
        add(Book, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 30, 140, 40));
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        ...
        if (btitle.isEmpty() || fname.isEmpty() || lname.isEmpty() || bdate.isEmpty() || bISBN.isEmpty() || bimage.isEmpty() || selectedGenre.isEmpty() || binventory < 0 || bprice <= 0.00) {
            ...
            Book book = new Book(btitle, fname, lname, bdate, binventory, brate, bISBN, bprice, bimage);
            String id = bdb.createBook(book);
            for (String genreid : selectedGenre) {
                bdb.addBookGenre(id, genreid);
            }
